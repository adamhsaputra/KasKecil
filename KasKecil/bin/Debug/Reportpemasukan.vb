...
Public Class Reportpemasukan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KasKecil.Reportpemasukan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportpemasukan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reportpemasukan = New Reportpemasukan()
        rpt.Site = Me.Site
        Return rpt
    End Function
